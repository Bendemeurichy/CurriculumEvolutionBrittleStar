...
def extract_observation(env_state, target=None):
    ...
    """
    # Extract joint positions for all arms
    joint_positions = []
    ...
    if target is not None:
        ...
        # Use target from environment state
...
get_observation = extract_observation
get_environment_dims = calculate_environment_dimensions
get_max_networks_dims = calculate_network_size_limits
init_pipeline = initialize_neat_pipeline
scale_actions = scale_actions_to_joint_limits

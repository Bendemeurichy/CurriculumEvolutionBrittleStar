...
MAX_STEPS_VISUALIZATION = 500  # Maximum steps for visualization

TIME_SCALE = 2  # Time scale for simulation
TARGET_DISTANCE = (
    2.0  # Target distance for locomotion (is ignored when TARGET_POSITION is set)
)
TARGET_POSITION = (
    None  # [0.43104,-2.96887,0] # None OR select a specific target position
)

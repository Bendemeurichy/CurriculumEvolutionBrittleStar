...
def create_brittle_star_morphology_specification(
    ...
    # Create actuation and sensor specifications
...
default_arm_segment_specification = create_arm_segment_specification
default_arm_specification = create_arm_specification
default_brittle_star_morphology_specification = create_brittle_star_morphology_specification
